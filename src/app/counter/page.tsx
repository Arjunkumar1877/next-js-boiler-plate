  ...
  return (
    <Container>
      <Card className="p-6 shadow-lg">
        <H3 className="text-center mb-4">Counter Application</H3>
        <P className="text-center text-gray-600 mb-6">Manage your counter state using Redux and styled components.</P>
